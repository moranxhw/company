        ...
        <div class="col-md-12 column">
            <ul class="nav nav-tabs">
                ...
                <li class="dropdown pull-right">
                    <!-- 搜索书籍 -->
                    <form class="sousuo" name="searchForm" method="POST" action="book/showNum?action=search"
            ...
            <table class="table table-striped table-hover">
                ...
                <tr class="success">
                    ...
                    <th width="170px">书名</th>
                    <th width="190px">作者</th>
                    <th width="100px">类别</th>
                    <th width="250px">出版社</th>
                    <th width="250px">入库时间</th>
                ...
                %>
                <form method="POST" action="book/modify?id=<%=book.getId()%>">
                    <tr>
                        <td><%=book.getId() %>
                        </td>
                        <td><%=book.getBookName() %>
                        ...
                        <td><input name="<%=book.getId()%>" size="7" type="text" value="<%=book.getBookNum()%>"></td>
                        <td><input type="submit" value="修改" name="xiugai"
                                   onclick="javascript:return confirm('是否确认修改？')">
                    </tr>
                </form>
                                ...
                                <tr>
                                    ...
                                    <td>点击跳转到第
                                        <select onchange="self.location.href=options[selectedIndex].value">
                                            ...
                                            <option value="book/showNum?pageNum=<%=tiaozhuan %>&keywords=<%=keywords %>&action=<%=action %>"><%=tiaozhuan %>
                                            </option>
                                            <% } %>
                                        </select>
                                        页
                                    ...
                                    <td>
                                        <a href="book/showNum?pageNum=<%=pageNum-1 %>&keywords=<%=keywords %>&action=<%=action %>"><input
